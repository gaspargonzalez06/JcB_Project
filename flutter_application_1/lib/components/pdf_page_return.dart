...
class _Pdf_Page_ReturnState extends State<Pdf_Page_Return> {
  ...
  getTotalFiltracion(){
    ...
    getTotalFiltracion_hora(){
      double suma1=tiempo1/(final1-inicio);
    ...
    getTotalLubri_hora(){
      double suma2=tiempo2/(final1-inicio);
    ...
    getTotalDesga_hora(){
      double suma1=tiempo3/(final1-inicio);
    ...
    getTotalMotor_hora(){
      double suma1=tiempo4/(final1-inicio);
    ...
    getTotalServo_hora(){
      double suma1=tiempo5/(final1-inicio);
    ...
    getTotalEje_Delan_hora(){
      double suma1=tiempo6/(final1-inicio);
    ...
    getTotalEje_Tra_hora(){
      double suma1=tiempo7/(final1-inicio);
    ...
    getTotalSiste_hidra_hora(){
      double suma1=tiempo8/(final1-inicio);
    ...
    getTotalBasti_hora(){
      double suma1=tiempo9/(final1-inicio);
    ...
    getTotalEle_hora(){
      double suma1=tiempo10/(final1-inicio);
    ...
    getTotal_hora(){
      double suma1=tiempo11/(final1-inicio);
                  ...
                  pw.Table(
                   ...
                   pw.TableRow(
                       ...
                       children: [
                         ...
                         pw.Flexible(flex: 1,child:pw.Image(pw.MemoryImage(image2),width: 120,height: 80,fit: pw.BoxFit.cover)),
                        
                         pw.Flexible(flex:2 ,child:pw.Text("Programa de Mantenimiento Preventivo ""\n" "Retroexcabadora 3cxb""\n" "(De "+inicio.toString()+" Hasta "+final1.toString()+" Horas)",style: pw.TextStyle(fontSize: 14,fontWeight: pw.FontWeight.bold),textAlign: pw.TextAlign.center), ),
                  ...
                  pw.Table(
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total Filtracion = "+getTotalFiltracion().toStringAsFixed(2)+"\n""costo x hora = "+getTotalFiltracion_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.Flexible(flex:2 ,child:pw.Text("Total Lubricacion = "+getTotalLubricacion().toStringAsFixed(2)+"\n""costo x hora = "+getTotalLubri_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total Desgaste = "+getTotalDesgaste().toStringAsFixed(2)+"\n""costo x hora = "+getTotalDesga_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total Motor = "+getTotalMotor().toStringAsFixed(2)+"\n""costo x hora = "+getTotalMotor_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total Servo_Transmision = "+getTotalServo_Transmision().toStringAsFixed(2)+"\n""costo x hora = "+getTotalServo_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total Eje Delantero = "+getTotalEje_Delantero().toStringAsFixed(2)+"\n""costo x hora = "+getTotalEje_Delan_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total Eje Trasero = "+getTotalEje_Trasero().toStringAsFixed(2)+"\n""costo x hora = "+getTotalEje_Tra_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total Sistemas Hidraulicos = "+getTotalSistemas_Hidraulicos().toStringAsFixed(2)+"\n""costo x hora = "+getTotalSiste_hidra_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total Bastidor = "+getTotalBastidor().toStringAsFixed(2)+"\n""costo x hora = "+getTotalBasti_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                   ...
                   pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total Electrico = "+getTotalElectrico().toStringAsFixed(2)+"\n""costo x hora = "+getTotalEle_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
                  ...
                  pw.TableRow(
                       ...
                       children: [
                        ...
                        pw.SizedBox(width:1 ),
                         ...
                         pw.Flexible(flex:2 ,child:pw.Text("Total De la Cotizacion  = "+getTotalCotizacion().toStringAsFixed(2)+"\n""costo x hora = "+getTotal_hora().toStringAsFixed(2),style: pw.TextStyle(fontSize: 10,),textAlign: pw.TextAlign.right,), ),
