...
$makeQuery = "SELECT `Id_Categoria`,`Nombre_Pieza`,`Cantidad_Piezas`,`Tiempo_Promedio`,`Precio_unidad` FROM `piezas_desgaste` where`Id_Categoria`=3 ";
...
$total_final=floatval($count2*$first_number);
