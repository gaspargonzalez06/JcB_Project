...
$id_equipo2 =$_POST["id_equipo"];
$id_quipo=intval($id_equipo2);

$makeQuery = "SELECT `Id_Categoria`,`Nombre_Pieza`,`Cantidad_Piezas`,`Tiempo_Promedio`,`Precio_unidad` FROM `piezas_desgaste`where `Id_Equipo`= $id_equipo2  ";
